...
$(window).on("load", function () {
  ...
  setTimeout(function () {
    ...
    $("#home-desktop-trigger").addClass("active-link");
  }, 300);
...
$(function () {
  ...
  let logoTrigger = $("#logo-trigger"),
    menu = $("#nav"),
    homeDesktopTrigger = $("#home-desktop-trigger"),
    aboutDesktopTrigger = $("#about-desktop-trigger"),
    workDesktopTrigger = $("#works-desktop-trigger"),
    contactDesktopTrigger = $("#contact-desktop-trigger"),
    header = $("#header"),
    footer = $("#footer");
  ...
  logoTrigger.on("click", function (event) {
    ...
    if (menu.hasClass("animate-in")) {
      ...
      setTimeout(() => {
        $(".active").removeClass("active animate-in");
        $(".loader").addClass("loaded");
        $(".active").removeClass("active");
        $(".active-link").removeClass("active-link");
        $("#main").addClass("active animate-in");
        $("#home-trigger").addClass("active-link");
        homeDesktopTrigger.addClass("active-link");
      }, 300);
    }
  });

  // home section open
  homeDesktopTrigger.on("click", function (event) {
    event.preventDefault();
    $(".active-link").removeClass("active-link");
    $(".active").removeClass("active");
    $(".loader").removeClass("loaded");
  ...
  // about section open
  aboutDesktopTrigger.on("click", function (event) {
    event.preventDefault();
    $(".active-link").removeClass("active-link");
    $(".active").removeClass("active");
    $(".loader").removeClass("loaded");
    ...
    setTimeout(function () {
      ...
      aboutDesktopTrigger.addClass("active-link");
    }, 500);
    setTimeout(function () {
      header.removeClass("menu-is-visible");
      footer.removeClass("menu-is-visible");
  ...
  // works section open
  workDesktopTrigger.on("click", function (event) {
    event.preventDefault();
    $(".active-link").removeClass("active-link");
    $(".active").removeClass("active");
    $(".loader").removeClass("loaded");
    ...
    setTimeout(function () {
      ...
      workDesktopTrigger.addClass("active-link");
    }, 500);
    setTimeout(function () {
      header.removeClass("menu-is-visible");
      footer.removeClass("menu-is-visible");
  ...
  // works section open
  contactDesktopTrigger.on("click", function (event) {
    event.preventDefault();
    $(".active-link").removeClass("active-link");
    $(".active").removeClass("active");
    $(".loader").removeClass("loaded");
    ...
    setTimeout(function () {
      ...
      contactDesktopTrigger.addClass("active-link");
    }, 500);
    setTimeout(function () {
      header.removeClass("menu-is-visible");
      footer.removeClass("menu-is-visible");
